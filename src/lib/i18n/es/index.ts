...
const es = {
	...
	auth: {
		...
		verification: 'Código de Verificación de Correo',
		verificationInstructions: "Bienvenido! Para completar el registro, debes ingresar el código de verificación que hemos enviado a tu correo:",
		fieldName: 'Nombre',
		...
		fieldVerificationCode: 'Código de Verificación',
		formSubmit: 'Ingresar',
	},
